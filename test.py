...
classifier = Classifier("/Users/ananyasangani/Downloads/converted_keras (11)/keras_model.h5", "/Users/ananyasangani/Downloads/converted_keras (11)/labels.txt")
offset = 20
imgSize = 300
...
while True:
    ...
    if hands:
        ...
        try:
            ...
            # Adjusted the rectangle size for the label
